"""Implémentation mémoire de :class:`LocalMutationJournalPort`."""
...
class InMemoryLocalMutationJournal(LocalMutationJournalPort):
    """Stockage volatile du journal des mutations."""
    ...
    def append(self, mutation: LocalMutation) -> None:
        """Voir :meth:`LocalMutationJournalPort.append`."""
    ...
    def replace(self, mutation: LocalMutation) -> None:
        """Voir :meth:`LocalMutationJournalPort.replace`."""
        key = mutation.mutation_id.value
